...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "auto","IUXray","Harvard","mimic","pmc_oa","quilt_1m","OpenPath","radiology","pathology"],
        default="auto",
    ...
    parser.add_argument(
        ...
        default=None,
        type=int,
        help="path to refered checkpoint",
    )
    parser.add_argument(
        "--precision",
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help='Retrieve top k results.'
    )
    parser.add_argument(
        "--retrieve_output_path",
        default="test_retrieve",
        type=str,
        help='Retrieve ouput path and file name'
    )
